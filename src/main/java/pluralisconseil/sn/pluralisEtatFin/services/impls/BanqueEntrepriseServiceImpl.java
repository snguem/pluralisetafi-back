...
public class BanqueEntrepriseServiceImpl implements BanqueEntrepriseService {
    private final BanqueEntrepriseRepository repository;
    private final BanqueEntrepriseMapper mapper;

    @Override
    public BanqueEntrepriseDto create(BanqueEntrepriseDto dto) {
    ...
    @Override
    public BanqueEntrepriseDto update(BanqueEntrepriseDto dto) {
        var entity = mapper.asEntity(dto);
        var entitySave = repository.save(entity);
        return mapper.asDto(entitySave);
    }
    ...
    public void delete(Long id) {
        if(!repository.existsById(id)) {
            throw new RuntimeException("BanqueEntreprise not found");
        }
        repository.deleteById(id);
    }

    @Override
    public BanqueEntrepriseDto get(Long id) {
        var entity = repository.findById(id);
        return mapper.asDto(entity.get());
    }

    @Override
    public Page<BanqueEntrepriseDto> getAll(Map<String, String> searchParams, Pageable pageable) {
    ...
    @Override
    public Page<BanqueEntrepriseDto> getAllByEntreprise(long entreprise_id, Map<String, String> searchParams, Pageable pageable) {
        var booleanBuilder = new BooleanBuilder();
...
//            var qEntity = QBanqueEntreprise.user;
        }
    }
}
